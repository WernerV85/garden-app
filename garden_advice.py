def get_options():
    ...
    '''Adding more options for season and plant type would enhance
    the program.'''
    ...
    return seasons, plant_types


def get_user_input(seasons, plant_types):
    ...
    plant_type = input(
        "Enter the type of plant (flower, vegetable, shrub, tree, herb): "
    ).lower()
...
def main():
    seasons, plant_types = get_options()
    season, plant_type = get_user_input(seasons, plant_types)
